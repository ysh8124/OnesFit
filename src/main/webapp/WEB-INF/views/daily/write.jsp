...
<script>
	$(function() {
		...
		$("#opbtn").on("click", function() {
			if($("#optext").css("display") == "block"){
				$("#optext").css("display","none");
			}else{
			$("#optext").css("display","block");
			}
		})
	...
	<div id=OSF_ALL>
		...
		<div id="container">
			...
			<div id="sidemenu">
				<div id="sidefix">
					...
					<div>
						...
						<ul>
							<li><a href="https://www.instagram.com/onesfit__official/?hl=ko" onclick="window.open(this.href,'_blank'); return false;"><img src="/img/instar.png" width="20px"
			...
			<div id="contents">
				...
				<form action="/daily/writeProc" method="post"
					...
					<div style="width: 100%; margin-top: 5px;">
						<input type="button" value="인스타그램" id="opbtn" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="선택사항 나의 인스타그램을 홍보해보세요!">
						<div id="optext"><input type="text" placeholder="인스타그램 ID를 입력해주세요." name="instargram" id="opintext"></div>
					</div>
