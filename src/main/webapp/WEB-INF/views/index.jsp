                     ...
                     <li class="box_li ${i.category} ${i.best}">
                        ...
                        <img src="/title/${i.title_img}"></a>
                           ...
                           <c:forEach var="j" items="${color}">
                              ...
                              <li style="color: #868686; font-family: 'BlinkMacSystemFont'; width: 350px; padding-right: 8%;">${i.pname}</li>
                              <li class="nums" style="font-family: 'BlinkMacSystemFont'; color: #868686; padding-right: 5%;"><B>${i.price}</B></li>
                           </ul>
                        </div>
                     </li>
                     </c:forEach>
