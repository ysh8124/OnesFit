...
-->
                                <div class="findId">
                                    <div style="position: relative; left: 19px"><h5><b>비밀번호 찾기</b></h5></div>
                                    <br>
                                    ...
                                    <fieldset>
                                        <div>
                                            <ul>
                                                <li><label><input placeholder="ID 입력" type="text" name="id"></label></li>
                                                <li><label><input type="text" placeholder="EMAIL 입력" id="email" name="email"></label></li>
                                        ...
                                        <div class="login_btn">
                                            <ul>
                                                <li>
                                                    <a href=""><button type="submit" value="아이디 찾기" class="btn btn-dark" style="font-size: 11px" id="pwsign">비밀번호 찾기</button></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </fieldset>
