...
<html>
    ...
    <style>
        *{box-sizing: border-box}
        ...
        /*    중앙 내용*/
        #contents{float: left; width: 1002px; height: 800px; margin-left: 420px; margin-top: 69px; font-size: 13px;}
                        ...
                        <ul>
                           <li><a
                              ...
                              onclick="window.open(this.href,'_blank'); return false;"><img
                                 ...
                                 style="position: relative; top: 6px; border-radius: 9px"></a>
                              <a href="https://open.kakao.com/me/onesfit2"><img src="/img/kakao.png" width="20px"
                                 style="position: relative; top: 6px; border-radius: 9px"></a>
