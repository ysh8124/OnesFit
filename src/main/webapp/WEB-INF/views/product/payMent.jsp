				...
				<div id="sidefix">
					...
					<div>
						...
						<ul>
							...
							<li><a href="https://www.instagram.com/onesfit__official/?hl=ko" onclick="window.open(this.href,'_blank'); return false;"><img src="/resources/images/instar.png"
									width="20px"
								...
								<tbody>
									<tr>
										...
										<td><input type="text" class="pinput" name="pname"
											...
											type="text" class="pinput" name="psize" value="${size }"
											style="width: 15px" readonly="readonly"><br>
											Color : <input type="text" class="pinput" name="pcolor"
											value="${color}" style="width: 30px" readonly="readonly"></td>
										...
										<td><input type="text" class="pinput" name="amount"
											value="${amount }" style="width: 30px" readonly="readonly"></td>
										<td>0</td>
										<td>${sum+3000 }원</td>
									</tr>
