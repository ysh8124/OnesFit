						...
						<div id="sidefix">
							...
							<div>
								<ul>
									...
									</a> <a href="https://open.kakao.com/me/onesfit"
										onclick="window.open(this.href,'_blank'); return false;"
										id='kakaotest'> <img src="/img/kakao.png" width="20px"
											style="position: relative; top: 6px; border-radius: 9px">
									</a> <a
			...
			<div id="contents">
				...
				<div id='maindetail'
					...
					<form action="payMent" method="post" name="payMent" id="frm">
						...
						<div style="height: 210px; font-size: 12px;">${pdto.content }</div>
						...
						<div id='subpic' style="position: relative; left: 40px;">
							<c:forEach var='i' items='${idto }'>
								<div
									...
									<img src="/product/${i.product_seq}/${i.sysname }"
										style="width: 100%;">
								</div>
							</c:forEach>
						</div>
						...
						<dl class="notice">
							...
							<dd class="editor_content">
								<table cellspacing="0" border="1" class="tb_view2 tb_view2_v2"
									style="border-left: hidden; border-right: hidden; border-top: #ededed; border-bottom: #ededed">
									<colgroup>
										<col width="345">
										<col>
									</colgroup>
												...
												<c:choose>
													...
													<c:otherwise>
														<td style="border-right: hidden">${i.title }&nbsp;<img
															src="/img/imgicon.png"
															style="position: relative; bottom: 2px; width: 25px; height: 25px;"></td>
													</c:otherwise>
												</c:choose>
						...
						<table id="reviewtable_write" style="display: none;">
							...
							<tr style="border-top: hidden;">
								...
								<td style="text-align: left;">&nbsp;&nbsp;<input
									name="title" type="text" style="width: 50%; height: 20px;"
									id="review_title"></td>
							</tr>
							<tr>
...
- 상품 후기 - (20자 이상으로 작성해 주시기 바랍니다.)
					...
					<form action="question" method="post">
						...
						<table id="qnatable_write" style="display: none;">
							...
							<tr style="border-top: hidden;">
								<td style="height: 35px; font-size: 12px;">&nbsp;&nbsp;제목</td>
								<td style="text-align: left;">&nbsp;&nbsp;<input id="qna_title"
									name="title" type="text" style="width: 50%; height: 20px;"></td>
							</tr>
							<tr>
								<td colspan="6"><textarea name="content" id="qna_content"
										style="width: 100%; height: 250px; font-size: 12px;"></textarea></td>
							</tr>
							<tr style="border: hidden; border-top: 1px">
								<td colspan="6" style="text-align: right"><input
									type="submit" value="상품문의하기 " id="qna_submit"
