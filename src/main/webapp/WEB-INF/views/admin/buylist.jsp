...
<body>
   ...
   <div style="margin-top: 60px;">
      <h2 style="font-size: 14px; text-align: center; margin-top: 100px;margin-left: 230px;">
         <b>BuyList</b>
      </h2>
   </div>
   <br>
   ...
   <div id="qnadiv" style="max-height: 1000px; max-width: 1000; overflow-y: :auto;">
               ...
               <c:when test="${!empty bList }">
                  <c:forEach var="i" items="${bList }">
                     <tr style="height: 40px;" class="userQuestion">
                        ...
                        <td>${i.amount }
                        <td>${i.recipient }
                        <td align=left>우편번호 : ${i.zipcode }<br>주소 : ${i.address1 }<br>${i.address2 }
                        <td>${i.phone }
                        <td>${i.msg }
                        <td>${i.status }
                        <td>${i.product_num }
