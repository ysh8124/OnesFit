...
<body>
	   ...
	   <div id=OSF_ALL>
                ...
                <div id="sidemenu">
                    <div id="sidefix">                
                        ...
                        <div>
                            ...
                            <ul>
                                <li> 
                                    <a href="https://www.instagram.com/onesfit__official/?hl=ko" onclick="window.open(this.href,'_blank'); return false;"><img src="/img/instar.png"
											width="20px"
		...
		<tr>
			<td colspan="7" style="text-align: center; width:1000px" >찜목록</td>
		</tr>
			...
			<c:otherwise>
				<c:forEach var="i" items="${list}">
					...
					<tr style="text-align: center;">
					    ...
					    <td style="width: 5%">${ i.seq}</td>
						<td style="width: 5%">${ i.homename}</td>
						<td style="width: 5%">${ i.takename}</a></td>
		...
		<tr>
			...
			<td colspan="1" style="text-align: right">
				<button type="button" id="write">배송지 작성</button>
			</td>
		</tr>
	</table>
